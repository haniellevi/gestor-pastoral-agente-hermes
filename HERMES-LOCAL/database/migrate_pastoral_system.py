...
BOTCONVERSA_CONFIG_DEFAULTS = [
    ...
    ("tag_atualizacao_6m_agendada", "", "Etiqueta BotConversa para atualização 6M agendada"),
    ...
    ("flow_confirmacao_cadastral_6m", "", "Fluxo BotConversa de confirmação cadastral semestral"),
    ...
    ("sequence_revisao_cadastral_6m", "", "Sequência de revisão cadastral semestral"),
    ...
    ("field_proxima_atualizacao", "", "Campo personalizado Proxima_Atualizacao_Cadastral"),
    ("field_proximo_recadastro_anual", "", "Campo personalizado Proximo_Recadastro_Anual"),
]
